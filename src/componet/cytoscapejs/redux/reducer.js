...
export default (state = {}, action) => {
    switch(action.type) {
      case ActionTypes.CYTOSCAPEJS_FULL: {
      ...
      case ActionTypes.CYTOSCAPEJS_NODE_MESSAGE: {
      ...
      case ActionTypes.CYTOSCAPEJS_UNFULL: {
        //let old_values=state.full;
        let new_value=false;
        //let new_state_values=Object.assign({},old_values,new_value)
        let new_state=Object.assign({},state,{full:new_value});
      ...
      case ActionTypes.CYTOSCAPEJS_CYPHER_CHANGE: {
